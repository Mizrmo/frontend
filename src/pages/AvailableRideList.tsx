            ...
            <div className={`arl-page-content${blurBg ? ' blurred' : ''}`}>
                <div className="rides-top-nav-container">
                    ...
                    <div className="nav-actions-row">
                        ...
                        <button className="skip-text-btn">Skip</button>
                    </div>
                </div>
                            ...
                            <div className="ride-card-left">
                                <div className="blue-z-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#0056B3" strokeWidth="2" />
                            ...
                            <div className="cr-car-card">
                                <div className="cr-car-icon-bg">
                                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                                        <path d="M5 17H3a1 1 0 0 1-1-1v-4c0-.85.6-1.57 1.41-1.87L5.5 9.5l1.5-3h10l1.5 3 2.09.63A2 2 0 0 1 22 12v4a1 1 0 0 1-1 1h-2" stroke="#0056B3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                                        <circle cx="7.5" cy="17.5" r="1.5" stroke="#0056B3" strokeWidth="1.8" />
                                        <circle cx="16.5" cy="17.5" r="1.5" stroke="#0056B3" strokeWidth="1.8" />
                                        <path d="M5 12h14" stroke="#0056B3" strokeWidth="1.8" strokeLinecap="round" />
                                    </svg>
                                </div>
