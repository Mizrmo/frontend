...
const styles = StyleSheet.create({
  ...
  passwordWrap: { position: 'relative', width: '100%', maxWidth: 362, justifyContent: 'center' },
  ...
  primaryBtn: { backgroundColor: '#0056B3', height: 45, width: '100%', maxWidth: 362, borderRadius: 42, justifyContent: 'center', alignItems: 'center', marginBottom: 15 },
  btnText: { color: '#FFF', fontFamily: 'Roboto_400Regular', fontSize: 16 },
  secondaryBtn: { borderWidth: 1, borderColor: '#000000', height: 45, width: '100%', maxWidth: 362, borderRadius: 42, justifyContent: 'center', alignItems: 'center' },
