...
const SLIDES = [
  {
    ...
    text: 'Cut down on commuting costs by carpooling with people headed your way.',
    image: require('../assets/welcome-screen.png'),
  },
  {
    id: '2',
    title: 'Reduce Emissions',
    text: 'Every shared ride means fewer cars on the road and cleaner air.',
    image: require('../assets/welcome-screen.png'),
  },
  {
    id: '3',
    title: 'Welcome To Mizrmo',
    text: 'We are a community built on respect and shared experiences.',
    image: require('../assets/welcome-screen.png'),
    last: true,
  },
];
...
export default function OnboardingScreen() {
  ...
  if (showSplash) {
    return (
      <TouchableOpacity
        style={[styles.container, styles.centered, { backgroundColor: '#0056B3' }]}
        activeOpacity={0.9}
    ...
    <View style={styles.container}>
      <FlatList
        ...
        onMomentumScrollEnd={(e) =>
          setCurrentIndex(Math.round(e.nativeEvent.contentOffset.x / Math.max(width, 1)))
        }
        ...
        renderItem={({ item }) => (
          <View style={[styles.slide, { width, height }]}>
            <Image
              source={item.image}
              style={{ width: width * 0.8, height: height * 0.35, marginBottom: 20 }}
              resizeMode="contain"
            />
...
const styles = StyleSheet.create({
  ...
  slide: { alignItems: 'center', padding: 40, justifyContent: 'center' },
