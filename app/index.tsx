...
const styles = StyleSheet.create({
  ...
  onboardingImg: { width: width * 0.8, height: height * 0.35, marginBottom: 40 },
  ...
  pagination: { flexDirection: 'row', position: 'absolute', bottom: 180, alignSelf: 'center' },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#EEE', marginHorizontal: 5 },
  activeDot: { backgroundColor: '#0056B3', width: 24 },
  footer: { position: 'absolute', bottom: 60, width: '100%', paddingHorizontal: 40 },
